...
public class StubDriverCreator extends DriverCreator {
  ...
  public ConstString toString_c() {
    return new ConstString(yarpJNI.StubDriverCreator_toString_c(swigCPtr, this), true);
  }

  public ConstString getName() {
    return new ConstString(yarpJNI.StubDriverCreator_getName(swigCPtr, this), true);
  }

  public ConstString getWrapper() {
    return new ConstString(yarpJNI.StubDriverCreator_getWrapper(swigCPtr, this), true);
  }

  public ConstString getCode() {
    return new ConstString(yarpJNI.StubDriverCreator_getCode(swigCPtr, this), true);
  }
